(() => {
  ...
  const EN = {
    ...
    'Dette fjerner alle egne middager fra denne profilen, skjuler standardmiddagene og tømmer ukeplanen. Fryseren beholdes. Vil du fortsette?': 'This removes all custom meals from this profile, hides the built-in meals and clears the weekly plan. The freezer is kept. Do you want to continue?',
    'Middagsbanken er tømt – profilen bruker nå kun egne middager': 'The meal library is cleared – this profile now uses custom meals only',
    'Standardmiddagene er tilgjengelige igjen': 'Built-in meals are available again',
    'Middagsbanken er tom. Legg til dine egne middager.': 'The meal library is empty. Add your own meals.',
    'Tøm alle middager og start med blank middagsbank': 'Clear all meals and start with a blank meal library',
    'Vis standardmiddagene igjen': 'Show the built-in meals again',
    'LAGER': 'STORAGE',
